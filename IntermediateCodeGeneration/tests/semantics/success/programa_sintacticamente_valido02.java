...
class Foo {
    ...
    static Object test(char a, char b, int c) // var int a, b; mismo nombre y diferente tipo, seria correcto?
...

    {
        ...
        foo = false;
        if ((new wasd('h', 777, 111 * 116 / 99, false || true).foo1() != false)) {
            j = (test1(1, "heyapple").foo());
        } else {
            w = (h + 3) % j;
...
class wasd {
    ...
    wasd(char c, int n1, int n2, boolean b) {}
