...
public class ClassEntry {
    ...
    private Hashtable<String, InstanceVariableEntry> instanceVariablesTable;
    private Hashtable<String, MethodEntry> methodsTable;    
    ...
    public void setConstructorEntry(String constructorName, int lineNumber) {
        ConstructorEntry constructor = new ConstructorEntry(constructorName, lineNumber);
     ...
     * @return methodsTable
     */
    public Hashtable<String, MethodEntry> getMethods() {
        return methodsTable;
    }
     ...
     */
    public void addInstanceVariableEntry(String instanceVariableName, Type type, int lineNumber) {
     ...
     */
    public Hashtable<String, InstanceVariableEntry> getInstanceVariables() {
        return instanceVariablesTable;
    }   
